...
const browserSync = require('browser-sync').create(); // BrowserSync for live reload
...
function js() {
    return src([
            ...
            'node_modules/marquee3000/marquee3k.min.js',
...
function staticFiles() {
    return src(['static/**/*', '!static/**/*.js', '!static/**/*.{png,jpg,jpeg,gif,svg,webp}'])
...
// Watch files
function watching() {
    watch('static/img/*/*', series(staticImages, reload));
    watch('static/js/*', series(staticJS, reload));
    watch('static/*', series(staticFiles, reload));
    watch('src/scss/*.scss', series(sassToCSS));
    watch('src/html/*.html', series(htmlFiles, reload));
}

// Tasks
exports.default = series(
    parallel(js, css, webFonts, staticImages, staticJS, staticFiles, sassToCSS, htmlFiles),
    serve,
    watching
);
